package com.sanedge.pointofsale.repository.category.stats;
...
public interface CategoryPriceRepository extends JpaRepository<Category, Long> {
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    List<CategoryMonthPrice> findMonthlyCategoryPrice(@Param("startYear") Integer startYear);
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    List<CategoryYearPrice> findYearlyCategoryPrice(@Param("startYear") Integer startYear);
}
