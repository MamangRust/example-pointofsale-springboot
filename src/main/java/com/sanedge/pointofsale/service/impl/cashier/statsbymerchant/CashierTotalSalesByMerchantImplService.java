...
public class CashierTotalSalesByMerchantImplService implements CashierTotalSalesByMerchantService {
    ...
    public ApiResponse<List<CashierResponseMonthTotalSales>> findMonthlyTotalSalesByMerchant(
        ...
        try {
            ...
            List<CashierMonthTotalSales> results = cashierTotalSalesByMerchantRepository.findMonthTotalSalesByMerchant(
            ...
            log.info("✅ Found {} monthly total cashier sales for merchant {}", response.size(), req.getMerchantId());
    ...
    public ApiResponse<List<CashierResponseYearTotalSales>> findYearlyTotalSalesByMerchant(YearTotalSalesMerchant req) {
        ...
        try {
            List<CashierYearTotalSales> results = cashierTotalSalesByMerchantRepository.findYearTotalSalesByMerchant(
                    req.getMerchantId().longValue(),
                    req.getYear(),
                    req.getYear() - 1);
            ...
            log.info("✅ Found {} yearly total cashier sales for merchant {}", response.size(), req.getMerchantId());
